package com.agilent.csda.phase1.service.impl;

import cn.hutool.core.util.StrUtil;
import com.agilent.csda.common.util.HttpUtil;
import com.agilent.csda.phase1.dto.InstrumentDto;
import com.agilent.csda.phase1.model.Dx;
import com.agilent.csda.phase1.model.Rslt;
import com.agilent.csda.phase1.repository.ProjectDao;
import com.agilent.csda.phase1.repository.RsltDao;
...
public class RsltServiceImpl implements RsltService {
    ...
    public List<InstrumentDto> doFindInstrumentsByPost() {
        ...
        List<InstrumentDto> result = HttpUtil.httpRequest(instrumentInfoUrl, HttpMethod.POST, request, new ParameterizedTypeReference<List<InstrumentDto>>(){});
        return result;
    }
}
