package com.agilent.iad.license;

import com.agilent.iad.license.server.LicenseGenerator;
import com.agilent.iad.license.server.LicenseProperties;
...
public class LicenseCreatorTest {
    ...
    public void generateLicenseTest() {
        ...
        // 证书授权主体
        param.setSubject("iad");
        // 私钥别名
        param.setPrivateAlias("iad_privateKey");
        // 私钥密码（需要妥善保管，不能让使用者知道）
        param.setKeyPass("agilent@123");
        // 访问私钥库的密码
        param.setStorePass("agilent@123");
        // 证书存储地址
        param.setLicensePath("license/iad_license.lic");
        // 私钥库所在地址
        param.setPrivateKeysStorePath("license/iad_privateKeys.keystore");
        // 证书生效时间
